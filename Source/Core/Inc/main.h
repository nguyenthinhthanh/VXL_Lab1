...
#define LED4_YELLOW_Pin GPIO_PIN_10
#define LED4_YELLOW_GPIO_Port GPIOB
#define LED4_GREEN_Pin GPIO_PIN_11
...
#define LED3_GREEN_Pin GPIO_PIN_8
#define LED3_GREEN_GPIO_Port GPIOB
#define LED4_RED_Pin GPIO_PIN_9
